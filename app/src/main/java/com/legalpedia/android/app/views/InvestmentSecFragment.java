...
import com.legalpedia.android.app.adapter.InvestmentSecAdapter;
...
public class InvestmentSecFragment extends Fragment {
    private Context ctx=null;
    private RecyclerView recyclerView=null;
    private TextView emptyView;
    private InvestmentSecAdapter adapter;
    private int offset=0;
    private int limit=50;
    private boolean isLoading = false;
    private boolean isLastPage = false;
    private DaoSession daoSession;
    public InvestmentSecFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        adapter=new InvestmentSecAdapter(ctx);
    ...
    public void searchFragment(String searchtext){
        ...
        if(searchtext.length()<=0){
            SQL_DISTINCT_ENAME = "SELECT " + SummaryDao.Properties.Id.columnName + "," + SummaryDao.Properties.Case_title.columnName + "," + SummaryDao.Properties.Date.columnName + "  FROM summary WHERE " +   SummaryDao.Properties.Courtid.columnName + "=6  ORDER BY " + SummaryDao.Properties.Date.columnName + " LIMIT 100";

        }else {
            SQL_DISTINCT_ENAME = "SELECT " + SummaryDao.Properties.Id.columnName + "," + SummaryDao.Properties.Case_title.columnName + "," + SummaryDao.Properties.Date.columnName + "  FROM summary WHERE " + SummaryDao.Properties.Case_title.columnName + " LIKE '" + searchtext + "%' AND " + SummaryDao.Properties.Courtid.columnName + "=6  ORDER BY " + SummaryDao.Properties.Date.columnName + " LIMIT 100";
        }
    ...
    class FetchFromDatabase extends AsyncTask<Integer, String, List<Summary>> {
        ...
        protected List<Summary> doInBackground(Integer ...offset) {
            ...
            try {
                ...
                resp= qb.where(SummaryDao.Properties.Courtid.eq(6)).orderDesc(SummaryDao.Properties.Date).offset(0).limit(20).list();
