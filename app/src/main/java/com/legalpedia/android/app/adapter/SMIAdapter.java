...
public class SMIAdapter extends RecyclerView.Adapter<SMIAdapter.SMIViewHolder> {
    ...
    class SMIViewHolder extends RecyclerView.ViewHolder {


        TextView title;
        TextView year;
        public SMIViewHolder(View v) {
            super(v);
    ...
    public SMIAdapter(Context context) {
    ...
    @Override
    public SMIAdapter.SMIViewHolder onCreateViewHolder(ViewGroup parent,
                                                           int viewType) {
        ...
        return new SMIAdapter.SMIViewHolder(view);
    }


    @Override
    public void onBindViewHolder(SMIAdapter.SMIViewHolder holder, final int position) {
