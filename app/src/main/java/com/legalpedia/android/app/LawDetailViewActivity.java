...
import com.legalpedia.android.app.views.LawDetailFragment;
...
public class LawDetailViewActivity extends AppCompatActivity {
    private String sectionid;
    private TextView titleView;
    private TextView bodyView;
    private Toolbar toolbar;
    private ViewPager viewPager;
    private LawDetailFragment law;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lawid = intent.getStringExtra("sectionid");
        Log.d("Law ID ",lawid);
