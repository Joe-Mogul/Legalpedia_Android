...
import com.legalpedia.android.app.views.RulesDetailFragment;
...
public class RulesDetailViewActivity extends AppCompatActivity {
    private String name;
    ...
    private RulesDetailFragment rulesfull;
...
/**
    ...
    private void setupViewPager(ViewPager viewPager) {
        rulesfull=new RulesDetailFragment();
