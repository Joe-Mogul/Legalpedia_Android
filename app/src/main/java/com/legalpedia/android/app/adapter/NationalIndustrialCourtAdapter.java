...
public class NationalIndustrialCourtAdapter extends RecyclerView.Adapter<NationalIndustrialCourtAdapter.NationalIndustrialCourtViewHolder> {
    ...
    class NationalIndustrialCourtViewHolder extends RecyclerView.ViewHolder {


        TextView title;
        TextView year;
        public NationalIndustrialCourtViewHolder(View v) {
            super(v);
    ...
    public NationalIndustrialCourtAdapter(Context context) {
    ...
    @Override
    public NationalIndustrialCourtAdapter.NationalIndustrialCourtViewHolder onCreateViewHolder(ViewGroup parent,
                                                                               int viewType) {
        ...
        return new NationalIndustrialCourtAdapter.NationalIndustrialCourtViewHolder(view);
    }


    @Override
    public void onBindViewHolder(NationalIndustrialCourtAdapter.NationalIndustrialCourtViewHolder holder, final int position) {
