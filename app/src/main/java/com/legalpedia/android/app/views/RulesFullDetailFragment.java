...
import com.legalpedia.android.app.RulesFullDetailViewActivity;
...
public class RulesFullDetailFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        RulesFullDetailViewActivity activity = (RulesFullDetailViewActivity)ctx;
    ...
    public SpannableStringBuilder getFullRules(String name){
        String fulllaw="";

        RulesDao rulesDao =daoSession.getRulesDao();
        QueryBuilder qb = rulesDao.queryBuilder();
        List<Rules> resp=qb.where(RulesDao.Properties.Name.eq(name)).orderAsc(RulesDao.Properties.Title).list();
    ...
    class UpdateRules  extends AsyncTask<String, String, SpannableStringBuilder> {
        ...
        protected SpannableStringBuilder doInBackground(String... offset) {
            ...
            SpannableStringBuilder lawbody = getFullRules(name);
