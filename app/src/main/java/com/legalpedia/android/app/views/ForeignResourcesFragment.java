...
public class ForeignResourcesFragment extends Fragment {
    private Context context;
    private ProgressDialog progressDialog;
    private NewsJournalActivity activity;
    public ForeignResourcesFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        String flrfeedurl = intent.getStringExtra("flrfeedurl");
        if(flrfeedurl==null){
            flrfeedurl="http://resources.legalpediaonline.com/flrfeed";
        }
