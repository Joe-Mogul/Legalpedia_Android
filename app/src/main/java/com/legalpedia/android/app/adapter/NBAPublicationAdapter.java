...
public class NBAPublicationAdapter extends RecyclerView.Adapter<NBAPublicationAdapter.NBAPublicationViewHolder> {
    ...
    class NBAPublicationViewHolder extends RecyclerView.ViewHolder {


        TextView title;
        TextView year;
        public NBAPublicationViewHolder(View v) {
            super(v);
    ...
    public NBAPublicationAdapter(Context context) {
    ...
    @Override
    public NBAPublicationAdapter.NBAPublicationViewHolder onCreateViewHolder(ViewGroup parent,
                                                                      int viewType) {
        ...
        return new NBAPublicationAdapter.NBAPublicationViewHolder(view);
    }


    @Override
    public void onBindViewHolder(NBAPublicationAdapter.NBAPublicationViewHolder holder, final int position) {
