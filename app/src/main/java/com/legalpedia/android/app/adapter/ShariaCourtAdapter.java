...
public class ShariaCourtAdapter extends RecyclerView.Adapter<ShariaCourtAdapter.ArticleViewHolder> {
    ...
    public ShariaCourtAdapter(Context context) {
    ...
    @Override
    public ShariaCourtAdapter.ArticleViewHolder onCreateViewHolder(ViewGroup parent,
                                                                   int viewType) {
        ...
        return new ShariaCourtAdapter.ArticleViewHolder(view);
    }


    @Override
    public void onBindViewHolder(ShariaCourtAdapter.ArticleViewHolder holder, final int position) {
