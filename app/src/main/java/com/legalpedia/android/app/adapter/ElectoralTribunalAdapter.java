...
public class ElectoralTribunalAdapter extends RecyclerView.Adapter<ElectoralTribunalAdapter.ElectoralTribunalHolder> {
    ...
    class ElectoralTribunalHolder extends RecyclerView.ViewHolder {


        TextView title;
        TextView year;
        public ElectoralTribunalHolder(View v) {
            super(v);
    ...
    public ElectoralTribunalAdapter(Context context) {
    ...
    @Override
    public ElectoralTribunalAdapter.ElectoralTribunalHolder onCreateViewHolder(ViewGroup parent,
                                                                         int viewType) {
        ...
        return new ElectoralTribunalAdapter.ElectoralTribunalHolder(view);
    }


    @Override
    public void onBindViewHolder(ElectoralTribunalAdapter.ElectoralTribunalHolder holder, final int position) {
