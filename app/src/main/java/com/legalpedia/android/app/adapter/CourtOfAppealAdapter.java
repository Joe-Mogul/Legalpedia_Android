...
public class CourtOfAppealAdapter extends RecyclerView.Adapter<CourtOfAppealAdapter.CourtOfAppealHolder> {
    ...
    class CourtOfAppealHolder extends RecyclerView.ViewHolder {


        TextView title;
        TextView year;
        public CourtOfAppealHolder(View v) {
            super(v);
    ...
    public CourtOfAppealAdapter(Context context) {
    ...
    @Override
    public CourtOfAppealAdapter.CourtOfAppealHolder onCreateViewHolder(ViewGroup parent,
                                                                     int viewType) {
        ...
        return new CourtOfAppealAdapter.CourtOfAppealHolder(view);
    }


    @Override
    public void onBindViewHolder(CourtOfAppealAdapter.CourtOfAppealHolder holder, final int position) {
